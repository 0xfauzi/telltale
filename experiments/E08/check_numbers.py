"""Every number in docs/experiments/E08.md, against the JSON under experiments/E08/out/.

The write-up quotes several hundred numbers and each one was typed or pasted by hand.
This reads them all back out of the prose and asks, of each, whether any number in
...
some are dates, some are section numbers of the design, and some are E03's or E07's own
measurements cited as theirs. Nothing here decides which is which. It prints the list,
...
OUT = E08_DIR / "out"
DOC = E08_DIR.parents[1] / "docs" / "experiments" / "E08.md"
