...
def launch(
    ...
    """The launch plan for a claude argv; the body lives in claude_launch.py.

    Imported lazily: claude_launch reads this module's constants, and a module-level
    import in both directions would be a cycle.
    """
    from telltale.providers.claude_launch import launch as _launch

    return _launch(argv, port, level, session_id, capture_id)
